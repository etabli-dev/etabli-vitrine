...
## Flutter (expose both — F-Droid users see this build)
```dart
ListTile(title: const Text('Support ☕ (Buy Me a Coffee)'),
  onTap: () => launchUrl(Uri.parse('https://buymeacoffee.com/rabanheller')));
